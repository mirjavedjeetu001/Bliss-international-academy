...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="section-header">Edit Teacher</h2>
            <p class="text-muted mb-0">Update teacher profile</p>
        </div>
    ...
    <form action="{{ route('backend.teacher.update', $teacher) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('qualification') is-invalid @enderror" 
                                      ...
                                      required>{{ old('qualification', $teacher->qualification) }}</textarea>
                            @error('qualification')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('campus') is-invalid @enderror" 
                                ...
                                <option value="Satkhira" {{ old('campus', $teacher->campus) === 'Satkhira' ? 'selected' : '' }}>Satkhira</option>
                                <option value="Debhata" {{ old('campus', $teacher->campus) === 'Debhata' ? 'selected' : '' }}>Debhata</option>
                            </select>
                            @error('campus')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" 
                                   ...
                                   id="sort_by" 
                                   name="sort_by" 
                                   value="{{ old('sort_by', $teacher->sort_by) }}" 
                                   min="0"
                        ...
                        <div class="mb-4">
                            <label for="picture" class="form-label">
                                <i class="fas fa-image me-2"></i>{{ $teacher->picture ? 'Change Picture' : 'Picture' }}
                            </label>
                            <input type="file" 
